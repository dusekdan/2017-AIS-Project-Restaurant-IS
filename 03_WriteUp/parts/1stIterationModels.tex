    ...
    \afterpage{
        ...
        \includepdf[angle=90,scale=0.80,
            pagecommand={
                \thispagestyle{plain}
                \null\vfill
                \captionof{figure}{Diagram interakce - sekvenční diagram - Zobrazit rezervace}}]{../02_Vysledne_modely/09_1_InteractionDiagram_SequenceDiagram_ShowReservations.pdf}
        \label{fig:iteration02}
        \clearpage
        \restoregeometry
    }
    ...
    \afterpage{
            ...
            \includepdf[angle=90,scale=0.75,
                pagecommand={
                    \thispagestyle{plain}
                    \null\vfill
                    \captionof{figure}{Model návaznosti jednotlivých obrazovek}}]{../02_Vysledne_modely/10_1_StateDiagram.pdf}
